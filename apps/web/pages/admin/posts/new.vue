...
async function onSubmit() {
  ...
  try {
    ...
    toast.add({ title: "Post criado!", color: "success" });
  ...
  <div class="max-w-4xl">
    ...
    <form class="flex flex-col gap-6" @submit.prevent="onSubmit">
          ...
          <template #pt>
            <div class="flex flex-col gap-4 pt-4">
              <UFormField label="Título *">
                <UInput v-model="form.content.pt.title" required placeholder="Título do artigo" />
              </UFormField>
          ...
          <template #en>
            <div class="flex flex-col gap-4 pt-4">
              <UFormField label="Title">
                <UInput v-model="form.content.en.title" placeholder="Article title" />
              </UFormField>
      ...
      <div class="flex gap-3">
        <UButton type="submit" :loading="saving">Salvar post</UButton>
